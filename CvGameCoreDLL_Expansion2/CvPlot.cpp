...
#if defined(FIX_AUI_UNIT_MOVEMENT_IROQUOIS_ROAD_TRANSITION_FIX)
...
#endif
{
    ...
    // iChange is nealry never 0
    // CUSTOMLOG("changeVisibilityCount team:% i , plotid: %i , ichange: %i", eTeam, GetPlotIndex(), iChange);
