...
// -- post defines --
	...
	GD_INT_INIT(PROM_UNLOCK_LVL_2, -1),
	GD_INT_INIT(PROM_UNLOCK_LVL_3, -1),
    GD_INT_INIT(PROM_UNLOCK_LVL_4, -1),
#endif
    ...
    GD_INT_INIT(BARBARIAN_NO_SPAWN_BEFORE_TURN, 10),
#endif
...
void CvGlobals::cacheGlobals()
{
	...
	if (MOD_LEVEL_PROMOTIONS) {
		GD_INT_CACHE(PROM_UNLOCK_LVL_2);
		GD_INT_CACHE(PROM_UNLOCK_LVL_3);
        GD_INT_CACHE(PROM_UNLOCK_LVL_4);
	}
#endif
	...
	if (MOD_CONFIG_GAME_IN_XML) {
        ...
        GD_INT_CACHE(BARBARIAN_NO_SPAWN_BEFORE_TURN);
	}
#endif
