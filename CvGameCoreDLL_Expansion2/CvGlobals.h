...
public:
	...
	GD_INT_DEF(PROM_UNLOCK_LVL_2)
	GD_INT_DEF(PROM_UNLOCK_LVL_3)
    GD_INT_DEF(PROM_UNLOCK_LVL_4)
#endif
    ...
    GD_INT_DEF(BARBARIAN_NO_SPAWN_BEFORE_TURN)
#endif
...
protected:
	...
	************************************************************************************************************************/
...
#if defined(MOD_LEVEL_PROMOTIONS)
	GD_INT_DECL(PROM_UNLOCK_LVL_2);
	GD_INT_DECL(PROM_UNLOCK_LVL_3);
    GD_INT_DECL(PROM_UNLOCK_LVL_4);
#endif
    ...
    GD_INT_DECL(BARBARIAN_NO_SPAWN_BEFORE_TURN);
#endif
